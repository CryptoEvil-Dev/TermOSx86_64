...
# reboot (Rust Extended Boot)
**reboot** - Раширенный 32-битный загрузчик на Rust. Новый подход к загрузке ОС. Новый загрузчик пока находится в разработке, его задачи:
- Поддержка 32-битной среды для запуска пользовательских программ для загрузки любой ОС.
- Эмуляция любой архитектуры: **reboot** должен позволять эмулировать любой процессор, включая ARM64.
- Поддержка Сокетов Беркли для загрузки ОС из сети (iPXE/NetBoot)
- Поддержка файловых систем (На ранних этапах ext2, ext3, ext4, NTFS, FAT32)
